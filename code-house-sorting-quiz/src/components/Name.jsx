...
export const Name = ( {handleStart, setUserName, setLastInitial} ) => {
    ...
    return (
        <form className="flex flex-col content-center" onSubmit={handleStart}>
            ...
            />
            <label className="text-4xl mt-8"> Enter the first <br></br>letter of your last name: </label>
            <input
                type="text"
                id="lastInitial"
                placeholder="A"
                ...
                className="bg-yellow-100 rounded-2xl p-8 mt-8 text-8xl w-1/5 border-8 border-amber-400 self-center text-black text-center"
            />
